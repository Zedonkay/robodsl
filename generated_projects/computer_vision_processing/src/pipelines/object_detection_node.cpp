...
object_detectionNode::object_detectionNode() 
    : Node("object_detection_node", "/computer_vision_pipeline/object_detection") {
...
void object_detectionNode::initialize_ros_components() {
    ...
    enhanced_image_sub_ = this->create_subscription<std_msgs::msg::String>(
        "/computer_vision_pipeline/object_detection/enhanced_image", 10,
        std::bind(&object_detectionNode::enhanced_image_callback, this, std::placeholders::_1)
    );
    
    // Initialize publishers
    detected_objects_pub_ = this->create_publisher<std_msgs::msg::String>(
        "/computer_vision_pipeline/object_detection/detected_objects", 10
    );
...
// Callback methods
void object_detectionNode::enhanced_image_callback(const std_msgs::msg::String::SharedPtr msg) {
