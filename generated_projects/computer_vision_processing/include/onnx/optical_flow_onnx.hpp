#ifndef OPTICAL_FLOW_ONNX_HPP
#define OPTICAL_FLOW_ONNX_HPP
...
class optical_flowOnnxInference {
public:
    optical_flowOnnxInference(const std::string& model_path);
    ~optical_flowOnnxInference();
