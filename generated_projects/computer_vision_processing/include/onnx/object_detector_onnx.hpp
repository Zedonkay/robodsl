#ifndef OBJECT_DETECTOR_ONNX_HPP
#define OBJECT_DETECTOR_ONNX_HPP
...
class object_detectorOnnxInference {
public:
    object_detectorOnnxInference(const std::string& model_path);
    ~object_detectorOnnxInference();
...
#endif // OBJECT_DETECTOR_ONNX_HPP 