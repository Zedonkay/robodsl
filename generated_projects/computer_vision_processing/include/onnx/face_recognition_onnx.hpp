#ifndef FACE_RECOGNITION_ONNX_HPP
#define FACE_RECOGNITION_ONNX_HPP
...
class face_recognitionOnnxInference {
public:
    face_recognitionOnnxInference(const std::string& model_path);
    ~face_recognitionOnnxInference();
...
#endif // FACE_RECOGNITION_ONNX_HPP 