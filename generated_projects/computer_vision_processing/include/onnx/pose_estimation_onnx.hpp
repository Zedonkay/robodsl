#ifndef POSE_ESTIMATION_ONNX_HPP
#define POSE_ESTIMATION_ONNX_HPP
...
class pose_estimationOnnxInference {
public:
    pose_estimationOnnxInference(const std::string& model_path);
    ~pose_estimationOnnxInference();
...
#endif // POSE_ESTIMATION_ONNX_HPP 