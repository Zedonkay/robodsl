#ifndef DEPTH_ESTIMATION_ONNX_HPP
#define DEPTH_ESTIMATION_ONNX_HPP
...
class depth_estimationOnnxInference {
public:
    depth_estimationOnnxInference(const std::string& model_path);
    ~depth_estimationOnnxInference();
...
#endif // DEPTH_ESTIMATION_ONNX_HPP 