#ifndef ROBODSL_PROJECT_FACE_RECOGNITION_ONNX_HPP
#define ROBODSL_PROJECT_FACE_RECOGNITION_ONNX_HPP
...
class face_recognitionOnnxManager {
public:
    face_recognitionOnnxManager();
    ~face_recognitionOnnxManager();
...
private:
    ...
    // Model file paths
    std::string face_recognition_model_path_;
...
#endif // ROBODSL_PROJECT_FACE_RECOGNITION_ONNX_HPP 