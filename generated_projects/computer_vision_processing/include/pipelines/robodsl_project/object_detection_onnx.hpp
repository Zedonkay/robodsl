#ifndef ROBODSL_PROJECT_OBJECT_DETECTION_ONNX_HPP
#define ROBODSL_PROJECT_OBJECT_DETECTION_ONNX_HPP
...
class object_detectionOnnxManager {
public:
    object_detectionOnnxManager();
    ~object_detectionOnnxManager();
...
private:
    ...
    // Model file paths
    std::string object_detector_model_path_;
...
#endif // ROBODSL_PROJECT_OBJECT_DETECTION_ONNX_HPP 