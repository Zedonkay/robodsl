#ifndef ROBODSL_PROJECT_POSE_ESTIMATION_ONNX_HPP
#define ROBODSL_PROJECT_POSE_ESTIMATION_ONNX_HPP
...
class pose_estimationOnnxManager {
public:
    pose_estimationOnnxManager();
    ~pose_estimationOnnxManager();
...
private:
    ...
    // Model file paths
    std::string pose_estimation_model_path_;
...
#endif // ROBODSL_PROJECT_POSE_ESTIMATION_ONNX_HPP 