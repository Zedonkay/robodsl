#ifndef ROBODSL_PROJECT_OPTICAL_FLOW_ONNX_HPP
#define ROBODSL_PROJECT_OPTICAL_FLOW_ONNX_HPP
...
class optical_flowOnnxManager {
public:
    optical_flowOnnxManager();
    ~optical_flowOnnxManager();
...
private:
    ...
    // Model file paths
    std::string optical_flow_model_path_;
...
#endif // ROBODSL_PROJECT_OPTICAL_FLOW_ONNX_HPP 