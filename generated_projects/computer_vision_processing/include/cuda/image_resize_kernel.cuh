...
/**
 * @brief CUDA kernel wrapper class for image_resize
 * 
 ...
 */
class image_resizeKernel {
public:
    /**
     * @brief Construct a new image_resize Kernel object
     * 
     * @param stream CUDA stream to use for kernel execution (nullptr for default stream)
     */
    explicit image_resizeKernel(cudaStream_t* stream = nullptr);
    
    /**
     * @brief Destroy the image_resize Kernel object
     * 
    ...
    image_resizeKernel(const image_resizeKernel&) = delete;
    image_resizeKernel& operator=(const image_resizeKernel&) = delete;
...
__global__ void image_resize_kernel(    const float** d_input_image_,    const int* d_input_width_,    const int* d_input_height_,    const int* d_channels_,    const float** d_output_image_,    const int* d_output_width_,    const int* d_output_height_,    int num_elements
);
