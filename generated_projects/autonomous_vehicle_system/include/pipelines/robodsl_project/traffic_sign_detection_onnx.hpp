#ifndef ROBODSL_PROJECT_TRAFFIC_SIGN_DETECTION_ONNX_HPP
#define ROBODSL_PROJECT_TRAFFIC_SIGN_DETECTION_ONNX_HPP
...
class traffic_sign_detectionOnnxManager {
public:
    traffic_sign_detectionOnnxManager();
    ~traffic_sign_detectionOnnxManager();
...
private:
    ...
    // Model file paths
    std::string traffic_sign_detector_model_path_;
...
#endif // ROBODSL_PROJECT_TRAFFIC_SIGN_DETECTION_ONNX_HPP 