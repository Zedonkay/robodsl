#ifndef ROBODSL_PROJECT_BEHAVIOR_PREDICTION_ONNX_HPP
#define ROBODSL_PROJECT_BEHAVIOR_PREDICTION_ONNX_HPP
...
class behavior_predictionOnnxManager {
public:
    behavior_predictionOnnxManager();
    ~behavior_predictionOnnxManager();
...
private:
    ...
    // Model file paths
    std::string behavior_predictor_model_path_;
...
#endif // ROBODSL_PROJECT_BEHAVIOR_PREDICTION_ONNX_HPP 