#ifndef ROBODSL_PROJECT_LANE_DETECTION_ONNX_HPP
#define ROBODSL_PROJECT_LANE_DETECTION_ONNX_HPP
...
class lane_detectionOnnxManager {
public:
    lane_detectionOnnxManager();
    ~lane_detectionOnnxManager();
...
private:
    ...
    // Model file paths
    std::string lane_detector_model_path_;
...
#endif // ROBODSL_PROJECT_LANE_DETECTION_ONNX_HPP 