#ifndef TRAFFIC_SIGN_DETECTOR_ONNX_HPP
#define TRAFFIC_SIGN_DETECTOR_ONNX_HPP
...
class traffic_sign_detectorOnnxInference {
public:
    traffic_sign_detectorOnnxInference(const std::string& model_path);
    ~traffic_sign_detectorOnnxInference();
...
#endif // TRAFFIC_SIGN_DETECTOR_ONNX_HPP 