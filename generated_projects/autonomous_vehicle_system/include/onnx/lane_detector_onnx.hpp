#ifndef LANE_DETECTOR_ONNX_HPP
#define LANE_DETECTOR_ONNX_HPP
...
class lane_detectorOnnxInference {
public:
    lane_detectorOnnxInference(const std::string& model_path);
    ~lane_detectorOnnxInference();
