#ifndef SEMANTIC_SEGMENTATION_ONNX_HPP
#define SEMANTIC_SEGMENTATION_ONNX_HPP
...
class semantic_segmentationOnnxInference {
public:
    semantic_segmentationOnnxInference(const std::string& model_path);
    ~semantic_segmentationOnnxInference();
...
#endif // SEMANTIC_SEGMENTATION_ONNX_HPP 