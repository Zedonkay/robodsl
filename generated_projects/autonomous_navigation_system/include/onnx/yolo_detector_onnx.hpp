#ifndef YOLO_DETECTOR_ONNX_HPP
#define YOLO_DETECTOR_ONNX_HPP
...
class yolo_detectorOnnxInference {
public:
    yolo_detectorOnnxInference(const std::string& model_path);
    ~yolo_detectorOnnxInference();
