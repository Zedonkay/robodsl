#ifndef FORCE_ESTIMATOR_ONNX_HPP
#define FORCE_ESTIMATOR_ONNX_HPP
...
class force_estimatorOnnxInference {
public:
    force_estimatorOnnxInference(const std::string& model_path);
    ~force_estimatorOnnxInference();
...
#endif // FORCE_ESTIMATOR_ONNX_HPP 