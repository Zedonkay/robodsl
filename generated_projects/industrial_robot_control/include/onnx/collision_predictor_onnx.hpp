#ifndef COLLISION_PREDICTOR_ONNX_HPP
#define COLLISION_PREDICTOR_ONNX_HPP
...
class collision_predictorOnnxInference {
public:
    collision_predictorOnnxInference(const std::string& model_path);
    ~collision_predictorOnnxInference();
...
#endif // COLLISION_PREDICTOR_ONNX_HPP 