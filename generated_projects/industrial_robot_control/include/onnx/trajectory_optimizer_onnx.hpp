#ifndef TRAJECTORY_OPTIMIZER_ONNX_HPP
#define TRAJECTORY_OPTIMIZER_ONNX_HPP
...
class trajectory_optimizerOnnxInference {
public:
    trajectory_optimizerOnnxInference(const std::string& model_path);
    ~trajectory_optimizerOnnxInference();
...
#endif // TRAJECTORY_OPTIMIZER_ONNX_HPP 