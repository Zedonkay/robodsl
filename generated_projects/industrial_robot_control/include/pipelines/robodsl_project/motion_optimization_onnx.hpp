#ifndef ROBODSL_PROJECT_MOTION_OPTIMIZATION_ONNX_HPP
#define ROBODSL_PROJECT_MOTION_OPTIMIZATION_ONNX_HPP
...
class motion_optimizationOnnxManager {
public:
    motion_optimizationOnnxManager();
    ~motion_optimizationOnnxManager();
...
private:
    ...
    // Model file paths
    std::string trajectory_optimizer_model_path_;
...
#endif // ROBODSL_PROJECT_MOTION_OPTIMIZATION_ONNX_HPP 