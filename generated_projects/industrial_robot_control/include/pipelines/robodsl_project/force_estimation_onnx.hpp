#ifndef ROBODSL_PROJECT_FORCE_ESTIMATION_ONNX_HPP
#define ROBODSL_PROJECT_FORCE_ESTIMATION_ONNX_HPP
...
class force_estimationOnnxManager {
public:
    force_estimationOnnxManager();
    ~force_estimationOnnxManager();
...
private:
    ...
    // Model file paths
    std::string force_estimator_model_path_;
...
#endif // ROBODSL_PROJECT_FORCE_ESTIMATION_ONNX_HPP 