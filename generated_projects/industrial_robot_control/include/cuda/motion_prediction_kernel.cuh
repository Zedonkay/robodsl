...
/**
 * @brief CUDA kernel wrapper class for motion_prediction
 * 
 ...
 */
class motion_predictionKernel {
public:
    /**
     * @brief Construct a new motion_prediction Kernel object
     * 
     * @param stream CUDA stream to use for kernel execution (nullptr for default stream)
     */
    explicit motion_predictionKernel(cudaStream_t* stream = nullptr);
    
    /**
     * @brief Destroy the motion_prediction Kernel object
     * 
     * Frees all allocated device memory.
     */
    ~motion_predictionKernel();
    
    // Delete copy constructor and assignment operator
    motion_predictionKernel(const motion_predictionKernel&) = delete;
    motion_predictionKernel& operator=(const motion_predictionKernel&) = delete;
...
__global__ void motion_prediction_kernel(    const float** d_joint_history_,    const int* d_history_length_,    const float** d_prediction_horizon_,    const float** d_predicted_joints_,    int num_elements
);
