...
/**
 * @brief CUDA kernel wrapper class for inverse_kinematics
 * 
 ...
 */
class inverse_kinematicsKernel {
public:
    /**
     * @brief Construct a new inverse_kinematics Kernel object
     * 
     * @param stream CUDA stream to use for kernel execution (nullptr for default stream)
     */
    explicit inverse_kinematicsKernel(cudaStream_t* stream = nullptr);
    
    /**
     * @brief Destroy the inverse_kinematics Kernel object
     * 
     * Frees all allocated device memory.
     */
    ~inverse_kinematicsKernel();
    
    // Delete copy constructor and assignment operator
    inverse_kinematicsKernel(const inverse_kinematicsKernel&) = delete;
    inverse_kinematicsKernel& operator=(const inverse_kinematicsKernel&) = delete;
...
__global__ void inverse_kinematics_kernel(    const float** d_target_pose_,    const float** d_current_joints_,    const float** d_joint_limits_,    const float** d_computed_joints_,    int num_elements
);
