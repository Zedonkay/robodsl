...
/**
 * @brief CUDA kernel wrapper class for force_control
 * 
 ...
 */
class force_controlKernel {
public:
    /**
     * @brief Construct a new force_control Kernel object
     * 
     * @param stream CUDA stream to use for kernel execution (nullptr for default stream)
     */
    explicit force_controlKernel(cudaStream_t* stream = nullptr);
    
    /**
     * @brief Destroy the force_control Kernel object
     * 
    ...
    force_controlKernel(const force_controlKernel&) = delete;
    force_controlKernel& operator=(const force_controlKernel&) = delete;
...
__global__ void force_control_kernel(    const float** d_desired_force_,    const float** d_measured_force_,    const float** d_current_pose_,    const float** d_stiffness_matrix_,    const float** d_force_correction_,    int num_elements
);
