...
#include "mppi_rollout_kernel.cuh"
#include <stdexcept>
#include <string>
#include <vector>
#include <cassert>
...
// Kernel function for mppi_rollout
__global__ void mppi_rollout_kernel() {
    // User's kernel code
    
}

// Implementation of Mppi_rolloutKernel methods
...
void Mppi_rolloutKernel::process() {
    ...
    try {
        ...
        // Launch kernel
        mppi_rollout_kernel<<<grid_dim, block_dim, 0>>>(        );
        ...
        free_device_memory();
        throw std::runtime_error(std::string("Error in mppi_rollout: ") + e.what());
    }
}