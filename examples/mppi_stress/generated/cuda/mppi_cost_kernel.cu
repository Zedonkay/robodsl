...
// Kernel function for mppi_cost
__global__ void mppi_cost_kernel() {
    // User's kernel code
    
}

// Implementation of Mppi_costKernel methods
...
void Mppi_costKernel::process() {
    ...
    try {
        ...
        // Launch kernel
        mppi_cost_kernel<<<grid_dim, block_dim, 0>>>(        );
        ...
        free_device_memory();
        throw std::runtime_error(std::string("Error in mppi_cost: ") + e.what());
    }
}