#ifndef ROBODSL_PROJECT_DETECTION_ONNX_HPP
#define ROBODSL_PROJECT_DETECTION_ONNX_HPP
...
class detectionOnnxManager {
public:
    detectionOnnxManager();
    ~detectionOnnxManager();
...
private:
    ...
    // Model file paths
    std::string detection_model_model_path_;
...
#endif // ROBODSL_PROJECT_DETECTION_ONNX_HPP 