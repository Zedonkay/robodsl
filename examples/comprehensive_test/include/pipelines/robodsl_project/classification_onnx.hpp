#ifndef ROBODSL_PROJECT_CLASSIFICATION_ONNX_HPP
#define ROBODSL_PROJECT_CLASSIFICATION_ONNX_HPP
...
class classificationOnnxManager {
public:
    classificationOnnxManager();
    ~classificationOnnxManager();
...
private:
    ...
    // Model file paths
    std::string classification_model_model_path_;
...
#endif // ROBODSL_PROJECT_CLASSIFICATION_ONNX_HPP 