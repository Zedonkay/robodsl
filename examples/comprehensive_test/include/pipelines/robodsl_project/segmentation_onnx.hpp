#ifndef ROBODSL_PROJECT_SEGMENTATION_ONNX_HPP
#define ROBODSL_PROJECT_SEGMENTATION_ONNX_HPP
...
class segmentationOnnxManager {
public:
    segmentationOnnxManager();
    ~segmentationOnnxManager();
...
private:
    ...
    // Model file paths
    std::string segmentation_model_model_path_;
...
#endif // ROBODSL_PROJECT_SEGMENTATION_ONNX_HPP 