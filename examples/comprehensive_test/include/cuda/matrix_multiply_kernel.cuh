...
__global__ void matrix_multiply_kernel(    const float** d_a_,    const float** d_b_,    const int* d_m_,    const int* d_n_,    const int* d_k_,    const float** d_c_,    int num_elements
);
