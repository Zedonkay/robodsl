#ifndef SEGMENTATION_MODEL_ONNX_HPP
#define SEGMENTATION_MODEL_ONNX_HPP
...
class segmentation_modelOnnxInference {
public:
    segmentation_modelOnnxInference(const std::string& model_path);
    ~segmentation_modelOnnxInference();
...
#endif // SEGMENTATION_MODEL_ONNX_HPP 