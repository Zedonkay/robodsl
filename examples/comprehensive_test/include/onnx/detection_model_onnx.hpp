#ifndef DETECTION_MODEL_ONNX_HPP
#define DETECTION_MODEL_ONNX_HPP
...
class detection_modelOnnxInference {
public:
    detection_modelOnnxInference(const std::string& model_path);
    ~detection_modelOnnxInference();
...
#endif // DETECTION_MODEL_ONNX_HPP 