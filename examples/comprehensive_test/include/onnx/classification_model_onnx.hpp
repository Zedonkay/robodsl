#ifndef CLASSIFICATION_MODEL_ONNX_HPP
#define CLASSIFICATION_MODEL_ONNX_HPP
...
class classification_modelOnnxInference {
public:
    classification_modelOnnxInference(const std::string& model_path);
    ~classification_modelOnnxInference();
...
#endif // CLASSIFICATION_MODEL_ONNX_HPP 