#ifndef MAIN_NODE_ONNX_HPP
#define MAIN_NODE_ONNX_HPP
...
class main_nodeOnnxInference {
public:
    main_nodeOnnxInference(const std::string& model_path);
    ~main_nodeOnnxInference();
