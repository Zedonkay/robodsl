...
// Kernel function for vector_add
__global__ void vector_add_kernel() {
    // User's kernel code
    
}

// Implementation of Vector_addKernel methods
...
void Vector_addKernel::process() {
    ...
    try {
        ...
        // Launch kernel
        vector_add_kernel<<<grid_dim, block_dim, 0>>>(        );
        ...
        free_device_memory();
        throw std::runtime_error(std::string("Error in vector_add: ") + e.what());
    }
}